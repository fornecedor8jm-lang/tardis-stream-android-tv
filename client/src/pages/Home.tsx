...
export default function Home() {
  ...
  const watchUrl = selected.episodes.find((episode) => episode.available)?.url || selected.sourcePage || homeSource;
  const openSource = () => window.location.assign(selected.sourcePage || homeSource);
  const watchNow = () => window.location.assign(watchUrl);
